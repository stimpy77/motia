...
export const CodeSandboxIcon: React.FC<IconProps> = ({ width = 14, height = 14, className = '' }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <path
        d="M12 1.5L1.5 7.5V16.5L12 22.5L22.5 16.5V7.5L12 1.5Z"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
